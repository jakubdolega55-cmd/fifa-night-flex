...
export const api = {
  ...
  gala:(year:number)=>jsonRequest<any>(`/api/v1/gala/${year}`),
  galaStart:(year:number)=>jsonRequest<any>(`/api/v1/gala/${year}/start`,{method:'POST'}),
  galaNext:(year:number)=>jsonRequest<any>(`/api/v1/gala/${year}/next`,{method:'POST'}),
  galaReplay:(year:number)=>jsonRequest<any>(`/api/v1/gala/${year}/replay`,{method:'POST'}),
  galaReset:(year:number)=>jsonRequest<any>(`/api/v1/gala/${year}/reset`,{method:'POST'}),
